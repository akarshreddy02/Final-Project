                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${sessionScope.userType == 'charitable_organization'}">
                                    <a href="${pageContext.request.contextPath}/CharitableItemsServlet?action=claim&item_id=${foodItem.id}" class="btn btn-primary" onclick="return confirm('Confirm claim?');">Claim</a>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>
